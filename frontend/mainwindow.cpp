...
{
    constexpr std::string_view api_key = "eGa7t3mip2WNVd9XiR";
    const std::string secret_key = "X6MIgs0BT5wAalKgOLMubF9SLcUfr51UWoai";
...
void MainWindow::on_pb_test_clicked()
{
    std::thread t([]() {
        ...
        WsClient client;
        std::string url = "wss://stream-testnet.bybit.com/v5/private";
        ...
        client.set_open_handler([&client](auto con_ptr) {
            ...
            std::string auth_msg = auth_message();
